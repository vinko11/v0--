...
import { ChevronLeft, MapPin, Calendar, Clock, CreditCard, Wallet, Check, AlertCircle, Navigation, ChevronDown } from "lucide-react"
        ...
        <div className="bg-card rounded-2xl p-4 w-full shadow-sm mb-6">
          <div className="flex gap-3">
            ...
            <div className="flex-1">
              ...
              <p className="text-primary font-bold text-sm mt-1">¥{getCurrentPrice()}</p>
            </div>
          </div>
        </div>
      ...
      <div className="p-4 space-y-4">
        ...
        <div className="bg-card rounded-2xl p-4 shadow-sm">
          ...
          <div className="flex items-center justify-between pt-2 border-t border-border">
            ...
            <span className="text-lg font-bold text-primary">¥{getCurrentPrice()}.00</span>
          </div>
        </div>
      ...
      <div className="fixed bottom-0 left-0 right-0 bg-card border-t border-border px-4 py-4">
        <div className="flex items-center gap-4">
          <div className="flex-1">
            ...
            <p className="text-xl font-bold text-primary">¥{getCurrentPrice()}.00</p>
          </div>
          <button
